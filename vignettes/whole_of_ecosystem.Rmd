...
type = sapply( taxa, FUN=switch, "benthic_detritus"="detritus", "Large phytoplankton"="auto", "Small phytoplankton"="auto", "hetero" )
...
We can compare equilibrium biomass between packages, although these obviously differ because we are estimating equilibrium biomass for arrowtooth and cod:
